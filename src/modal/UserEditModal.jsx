...
export const UserEditModal = (props) => {
  // console.log(`I am in UserEditModal`)
  return (
    <div>
            ...
            <div className="col-md-6">
              <div className="card">
                  ...
                  <div className="row">
                    <div className="col">
                      <h6><i className="fa fa fa-forward" aria-hidden="true"></i>
                        Edit <span className="badge badge-success">{`UserId = ${props.selectedUser}`}</span>
                      </h6>
                    </div>
                  </div>
                </div>
                <div className="card-body">
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <button className="btn btn-outline-success btn-md btn-block custom-button" onClick={props.afterOpenModal}>Edit </button>
                    </div>
                    <div className="col-md-6">
